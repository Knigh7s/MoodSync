...
public class Config {
    ...
    public static final boolean IGNORE_BLACK_LINES = true; //any row completely filled with black will be ignored - useful for letterboxed video
    public static final int WHITE_TEMPERATURE = 5500; //kelvin
    public static final int MINIMUM_COLOR_DOMINANCE = 99; // out of 255
